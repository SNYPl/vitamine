...
export const metadata = {
  ...
  description:
    "Our terms and conditions outline the rules, guidelines, and agreements for using our website and services.",
};
        ...
        <div className={styles.termsContent}>
          ...
          <section className={styles.termsSection}>
            ...
            <p>
              ...
              conditions in full. Do not continue to use our website if you do
          ...
          <section className={styles.termsSection}>
            ...
            <p>
              ...
              for all material on this website. All intellectual property rights
              are reserved. You may view and/or print pages from our website for
            ...
            <ul>
              ...
              <li>
                Redistribute content from our website, unless content is
          ...
          <section className={styles.termsSection}>
            ...
            <p>
              We may, at our sole discretion, delete your account at any time
          ...
          <section className={styles.termsSection}>
            ...
            <p>
              ...
              videos, or other material. You are responsible for the legality,
              reliability, and appropriateness of any content you post on the
              website.
            </p>
            <p>
              By posting content on our website, you grant us the right to use,
          ...
          <section className={styles.termsSection}>
            ...
            <ul>
              ...
              <li>
                Make any unauthorized use of the website, including collecting
          ...
          <section className={styles.termsSection}>
            ...
            <p>
              ...
              shall we be liable for any indirect, punitive, incidental,
          ...
          <section className={styles.termsSection}>
            ...
            <div className={styles.contactInfo}>
              <p>By email: vitamine.vitvit@gmail.com</p>
              <p>By phone: +995 558383881</p>
            </div>
          </section>
        </div>
      </div>
